...
class ContactForm(forms.Form):
	...
	education_3=forms.CharField()
	education_3_dur=forms.CharField()
	education3_score=forms.CharField()
	...
	def __init__(self,*args,**kwargs):
		...
		self.helper.layout=Layout(
			...
			'education_3',
			Row(
				Column('education_3_dur', css_class='form-group col-md-6  mb-10'),
				Column('education3_score', css_class='form-group col-md-6 mb-10'),
				css_class='form-row  center'
